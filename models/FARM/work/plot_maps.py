...
class Settings(BaseModel):
    ...
    path_netcdf: str = (
        "/mnt/mumbai_n4r5/dausilio/projects/DART/models/FARM/IRIDE_ens/posteriors/20210108_121500/posterior_0.nc"
    )
...
def main():
    ...
    dataset = dataset.assign_coords(
        x=(dataset.x.values * 0.15) + 5.325,
        y=(dataset.y.values * 0.103) + 35.380,
        # x=dataset.x.values,
        # y=dataset.y.values,
    )
    ...
    station_points = pd.read_csv(
        "/mnt/mumbai_n4r5/dausilio/projects/eea_app/E1a/station_data.csv"
    )
